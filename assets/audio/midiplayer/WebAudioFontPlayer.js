(function(){function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s}return e})()({1:[function(require,module,exports){
    ...
    function WebAudioFontPlayer() {
        ...
        this.queueWaveTable = function (audioContext, target, preset, when, pitch, duration, volume, slides) {
            ...
            // Use softer waves for more pleasant 8-bit sound
            // Different types for different instrument ranges
            if (pitch < 48) {
                oscillator.type = 'sine'; // Bass sounds - more rounded
            } else if (pitch < 72) {
                oscillator.type = 'triangle'; // Mid-range melody - softer than square
            } else {
                oscillator.type = 'triangle'; // High melody - softer than square
            }
            ...
            // Softer 8-bit style envelope (slightly smoother transitions)
            var attackTime = 0.02;  // Slightly slower attack for smoother start
            var decayTime = 0.08;   // Longer decay for more natural fade
            var sustainLevel = volume * 0.8; // Higher sustain level
            var releaseTime = 0.08; // Slower release for smoother end
    ...
    function WebAudioFontReverberator(audioContext) {
        ...
        this.dry.gain.setTargetAtTime(0.85,0,0.0001);
        this.dry.connect(this.output);
        this.wet = audioContext.createGain();
        this.wet.gain.setTargetAtTime(0.15,0,0.0001);
